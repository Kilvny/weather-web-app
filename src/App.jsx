  ...
  return (
    <body className="bg-black text-amber-100 max-w-full w-screen h-screen">
      <div className="flex flex-col justify-center items-center">
        ...
        ></input>
        <div
          className={`bg-white text-black flex flex-col border-gray-700 border-soild border-2 empty:border-none min-w-fit opacity-90 rounded`}
        >
          {cities
            .filter((city) => {
            ...
            .map((city, i) => (
              <div
                className="cursor-pointer text-start my-0.5 mx-1 border-b-2 font-sans opacity-75"
                key={i}
...
function App() {
    return (
        <RouterProvider 
        router={router} 
        fallbackElement={<HashLoader color="#36d7b7" />}
        />
    )
}
